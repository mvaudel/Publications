...
This repository lists the scientific publications I co-authored as of `r format(Sys.time(), "%d.%m.%Y")`. 

- [NIH iCite](https://icite.od.nih.gov/analysis?search_id=r21kkqcurn75ir0t)
...
1. Bjørlykke Y, Søviknes AM, Hoareau L, Vethe H, Mathisen AF, Chera S, **Vaudel M**, Ghila L, Ræder H<sup>:email:</sup>, _Reprogrammed cells display distinct proteomic signatures associated with colony morphology variability_, Stem Cells International, 2019. `r getLinks(journalDOI = "10.1155/2019/8036035")`
